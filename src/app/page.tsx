          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href={isAuthenticated ? "/dashboard" : "/products"}>
                  <Button size="lg" className="text-lg px-8 py-4">
                    <ShoppingBag className="ml-2 h-5 w-5" />
                    {isAuthenticated ? "لوحة التحكم" : "تسوق الآن"}
                  </Button>
                </Link>
                <Link href={isAuthenticated ? "/products" : "/register"}>
                  <Button variant="outline" size="lg" className="text-lg px-8 py-4">
                    {isAuthenticated ? "تصفح المنتجات" : "انضم كبائع"}
                  </Button>
                </Link>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href={isAuthenticated ? "/dashboard" : "/register"}>
              <Button size="lg" variant="secondary" className="text-lg px-8 py-4">
                {isAuthenticated ? "لوحة التحكم" : "إنشاء حساب جديد"}
              </Button>
            </Link>
            <Link href="/products">
