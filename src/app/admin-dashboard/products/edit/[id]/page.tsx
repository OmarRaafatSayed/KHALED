...
export default function EditProduct() {
  ...
  const [form, setForm] = useState<ProductForm>({
    ...
    description: 'هاتف ذكي متطور من Apple مع كاميرا احترافية وأداء فائق',
    shortDescription: 'أحدث هواتف Apple الذكية',
    ...
    images: [],
    existingImages: ['/api/placeholder/200/200', '/api/placeholder/200/200'],
    seo: { 
      title: 'iPhone 15 Pro Max - أحدث هواتف Apple', 
      description: 'اشتري iPhone 15 Pro Max بأفضل سعر مع ضمان شامل وشحن مجاني',
      keywords: 'iPhone, Apple, هاتف ذكي, كاميرا احترافية' 
    },
    status: 'active',
    featured: true
  });
            ...
            {activeTab === 'images' && (
              <div className="space-y-6">
                ...
                {form.images.length > 0 && (
                  <div>
                    <h3 className="text-sm font-medium text-gray-700 mb-3">الصور الجديدة</h3>
            ...
            {activeTab === 'seo' && (
              <div className="space-y-6">
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    الطول المثالي: 50-60 حرف (الحالي: {form.seo.title.length})
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    الطول المثالي: 150-160 حرف (الحالي: {form.seo.description.length})
                  </p>
                </div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="bg-white p-3 rounded border">
                    ...
                    <div className="text-green-600 text-sm">
                      https://example.com/products/{form.sku.toLowerCase() || 'product-url'}
                    </div>
